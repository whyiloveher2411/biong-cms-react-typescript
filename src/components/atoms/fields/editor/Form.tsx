                ...
                document.querySelector('#warperMain').addEventListener('scroll', function () {
                    ...
                    document.querySelectorAll('.warpper-editor').forEach(function (el) {
                        ...
                        if ($menubar) {
                            ...
                            if (top <= 156 && dk) {
                                //@ts-ignore
                                Object.assign($menubar.style, { position: 'fixed', top: 148 + 'px', left: 'unset' });
                            } else {
                                //@ts-ignore
            ...
            window.tinymce.init({
                ...
                setup: function (editor: any) {
                    ...
                    editor.on('init', function (_args: any) {
                        ...
                        var css = ':root { --color: ' + theme.palette.text.primary + ' }.mce-content-body[data-mce-placeholder]:not(.mce-visualblocks)::before{color: ' + theme.palette.text.secondary + ';opacity:0.7}',
