...
export default function Timezone(props: FieldFormItemProps) {
    ...
    React.useEffect(() => {
        ...
        let optionsInitial = Object.keys(country).map((key: string) => {
    ...
    return (
        <Autocomplete
            ...
            disableClearable
            options={options}
            onChange={(_e, option: Option) => { onReview(option.value); setValue(option); }}
            isOptionEqualToValue={(option: Option, value: Option) => option.value === value.value}
            defaultValue={value}
            value={value}
            groupBy={(option: Option) => option.filter}
